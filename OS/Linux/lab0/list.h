...
/* *
 * list_add - add a new entry　在节点之后添加元素节点
...
list_add(list_entry_t *listelm, list_entry_t *elm) {
    list_add_after(listelm, elm);// 在节点之后添加元素节点
}
...
list_add_before(list_entry_t *listelm, list_entry_t *elm) {
    __list_add(elm, listelm->prev, listelm);// 在节点之前添加元素节点
}
...
list_add_after(list_entry_t *listelm, list_entry_t *elm) {
    __list_add(elm, listelm, listelm->next);// 在节点之后添加元素节点
}
...
list_del(list_entry_t *listelm) {
    __list_del(listelm->prev, listelm->next);//删除链表节点
}
