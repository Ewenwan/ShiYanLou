...
bool Copter::set_mode(control_mode_t mode, mode_reason_t reason)
{
    ...
    switch (mode) {
		...
		//case NEWFLIGHTMODE:  // 与 defines.h 中定义的 一致
			 // success = newflightmode_init(ignore_checks); //  与 newflightmode.cpp 定义的初始化函数一致
            //break;
        default:
            success = false;
            break;
...
void Copter::update_flight_mode()
{
    ...
    switch (control_mode) {
        ...
        case ALT_HOLD:                   //高度保持模式 //AltHold_MotorStopped;//电机停止状态下
		//AltHold_Takeoff;//刚起飞 状态下  // AltHold_Landed;//着陆状态下     // AltHold_Flying;// 飞行状态下 
            althold_run();
            break;
        ...
        case GUIDED_NOGPS:
            ...
            break;
        //case NEWFLIGHTMODE:  // 与 defines.h 中定义的 一致
        //    newflightmode_run(); //  与 newflightmode.cpp 定义的运行函数一致
        //    break;
